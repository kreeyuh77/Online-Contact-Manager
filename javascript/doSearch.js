    ...
    for (var i = 0; i < array.length; i++)
    {
      ...
      for (var j = 0; j < 8; j++)
      {
          table+= "<td>" + array[i][j] + "</td>";
       	...
       	table +="<td><span id='editContactButton' style='width:auto;height:25px;margin-right:20px;' onclick='editContactHelper(" + array[i][8] + ")';><i class='fas fa-edit'></i></span><span id='deleteContactButton' style='width:auto;height:25px' onclick='deleteContactHelper(" + array[i][8] + ")';><i class='fas fa-trash-alt'></i></span></td>";
      table+="</tr>";
