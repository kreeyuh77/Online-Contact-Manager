...
function createTable(array)
{
    ...
    for (var i = 0; i < array.length; i++)
    {
      ...
      table +="<td>"<input type='image' src='media/pencil.png' height='35px' class='editform' id='pencil' onclick='editContact(" + array[i][5] + ")';><input type='image' src='media/delete.png' height='35px' class='editform' id='trash' onclick='deleteContact(" + array[i][5] + ")';></td>";
